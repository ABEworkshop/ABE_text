...
the adversary, who is qualified to data$1$ and not to data$2$, obtains the the private key for his access structure from himself, in order to break the data$1$ .
