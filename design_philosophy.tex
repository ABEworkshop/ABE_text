...
\textbf{Key Generation}$(MK,S)$. The key generation algorithm takes as input the master key $MK$ and a set of attributes S that describe the key. It outputs a private key $SK$.\newline\newline
