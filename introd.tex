...
When everything occurs to us,the ultimate questions of which we would like to know the answer are always about past,now,and future.Now those happen to ABE.Detailedly,the three questions are:\subsubsection{Where does ABE come from?}\subsubsection{What¡¯s the essence of ABE?and how is it going?}\subsubsection{where will ABE go?}Our motivation is finding out the answers of these three questions.
...
\subsubsection{what's the reasons for emergences of those kinds of ABE schemes?}

\subsubsection{what's the relationship among ABE schemes?}

\subsubsection{what's the more possible work along developed directions of ABE?}
